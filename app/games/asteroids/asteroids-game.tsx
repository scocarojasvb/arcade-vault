...
import { ASTEROIDS_SKINS, type AsteroidsSkin } from "./skins";
...
export default function AsteroidsGame({ paused, skin, onStateChange, onGameOver }: RealGameProps) {
  ...
  useEffect(() => {
    ...
    let lastEmitted = { score: -1, lives: -1, level: -1 };
